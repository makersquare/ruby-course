...
describe Book do
  ...
  it "can't be checked out twice in a row" do
    ...
    did_it_work_again = book.checkout
...
#checkout book by id 
  it "allows a Borrower to check out a book by its id" do
    ...
    # Sam wants to check out Green Eggs and Ham
     ...
     book = lib.checkout_book(book_id, sam)
...
#checkout knows who borrowed the book by id 
...
#checkout same book for same person no possible
  ...
  it "allows a Borrower to check a book back in" do
    ...
    book = lib.checkout_book(book_id, bob)
    ...
    book = lib.checkout_book(lib.available_books.first.id, jordan)
    ...
    book = lib.checkout_book(book_id, vick)
    ...
    book = lib.checkout_book(book_id, schumacher)
    ...
    book = lib.checkout_book(lib.borrowed_books.first.id, kors)
