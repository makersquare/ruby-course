...
describe Book do
  ...
  it "has a default status of available" do
    book = Book.new("Responsive Websites", "Hacker Van Code")
    expect(book.status).to eq 'available'
  end

  it "can be checked out" do
    book = Book.new("Doge Quotes", "Much Wow")
  ...
  it "can't be checked out twice in a row" do
    book = Book.new("Books I've Read", "Sarah Palin")
    did_it_work = book.check_out
  ...
  it "can be checked in" do
    book = Book.new("Fundamentals of Gardening", "Lee Greenthumb")
    book.check_out
    book.check_in
    expect(book.status).to eq 'available'
  end
...
describe Library do
  ...
  it "can add multiple books" do
    lib = Library.new("New Media Library")
  ...
  it "allows a Borrower to check out a book by its id" do
    lib = Library.new("Bibliotheque on the Sea")
  ...
  it "knows who borrowed a book" do
    lib = Library.new("Computer Science Library")
