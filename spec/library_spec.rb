...
describe Book do
  ...
  it "can be checked out" do
    book = Book.new("The Stranger", "Albert Camus")
    sam = Borrower.new("sam")
    did_it_work = book.check_out(sam)
  ...
  it "can't be checked out twice in a row" do
    ...
    sam = Borrower.new("sam")
    did_it_work_again = book.check_out(sam)
...
describe Library do
  ...
  it "returns available books" do
    ...
    expect(lib.available_books.first.is_a? Book).to eq(true)
  ...
  it "returns borrowed books" do
    ...
    expect((lib.borrowed_books.first).is_a? Book).to eq(true)
  end
end
