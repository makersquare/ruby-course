...
describe Book do
  ...
  it "has a default status of available" do
    book = Book.new("Nine Stories", "J.D. Salinger")
...
describe Library do
  ...
  it "allows a Borrower to check out a book by its id" do
    lib = Library.new("Green Eggs and Ham")
  ...
  it "knows who borrowed a book" do
    lib = Library.new("The Brothers Karamazov")
