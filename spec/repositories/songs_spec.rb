...
describe Songify::Repositories::Songs do
  ...
  let(:song) { Songify::Song.new('When the Levee Breaks', 'Led Zeppelin', 'Led Zeppelin IV', 1971) }
  let(:song2) { Songify::Song.new('Mr. Brightside', 'The Killers', 'Hot Fuss', 2003) }
  let(:song3) { Songify::Song.new("Since Ive Been Loving You", 'Led Zeppelin', 'Led Zeppelin III', 1970) }
  let(:song4) { Songify::Song.new('Daylight', 'Matt and Kim', 'Grand', 2009) }
